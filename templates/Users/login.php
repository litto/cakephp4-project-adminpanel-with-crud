...
<div id="main" role="main">
      ...
      <form class="lockscreen animated flipInY" method="post" enctype="multipart/form-data" action="/login/">
        <div class="logo">
        ...
        <div>
          ...
          <div>
            <h1><i class="fa fa-user fa-3x text-muted air air-top-right hidden-mobile"></i>Admin Login </h1>
              ...
              <input class="form-control" type="text" name="email" value="<?php echo $user;?>" placeholder="Username">
